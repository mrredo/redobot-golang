...
export default function GuildSettings() {
    ...
    useEffect(() => {
      ...
      return (
          <div className="data">
              <NavBar />
            <h1 className="text-white rounded-3xl lg:text-5xl sm:text-4xl p-2 ml-4 mr-4 mt-16 border-4 border-gray-800 text-center">
                Edit  server settings
            </h1>
            <div className="links grid grid-cols-3 md:grid-cols-2">
                    <a className="no-underline border-2 rounded-lg w-[95%] py-4 text-3xl md:text-2xl mt-3 font-bold text-center hover:no-underline transition-all duration-500 hover:bg-white hover:text-black" 
                        href={`/guilds/${(guild as any).id}/settings`}>
                        Settings
                    </a>
